document.addEventListener('DOMContentLoaded',(e) => {
    ...
    (function () {
        ...
        const $navBurger = Array.prototype.slice.call(document.querySelectorAll('.navbar-burger'),0);
        ...
        function inputSetStyle(input, valid = true) {
            if (valid) {
                ...
                if (input.nextElementSibling.nextElementSibling) {
                    input.nextElementSibling.nextElementSibling.firstElementChild.style.color = 'rgb(0, 209, 178)';
                }
                ...
                if (input.nextElementSibling.nextElementSibling) {
                    input.nextElementSibling.nextElementSibling.firstElementChild.style.color = 'rgb(243, 68, 1)';
                }
            }
        }
        ...
        if (document.querySelector('#register-submit')) {
            ...
            let validator = new FormValidator(document.querySelector('#register-form'));

            function unlockSubmit() {

                if (validator.isValid('email', $email) && validator.isValid('username', $username) && validator.isValid('password', $pass) && $passwordConfirmation.value === $pass.value) {
